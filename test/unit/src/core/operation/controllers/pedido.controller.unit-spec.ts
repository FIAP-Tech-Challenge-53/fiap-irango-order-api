...
describe("Test for PedidoController Class", () => {
    ...
    it("update method test", async () => {
        ...
        let result = await controller.update(1, updateDto);
    ...
    it("confirmPayment method test", async () => {
        ...
        let result = await controller.confirmPayment(1);
    ...
    it("startCooking method test", async () => {
        ...
        let result = await controller.startCooking(1);
    ...
    it("finishCooking method test", async () => {
        ...
        let result = await controller.finishCooking(1);
