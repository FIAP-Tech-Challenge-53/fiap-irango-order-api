...
```bash
# With docker
docker compose run irangoorder-api npm run test
...
```bash
# With docker
docker compose run irangoorder-api npm run test:integration
...
```bash
# With docker
docker compose run irangoorder-api npm run test:integration:one <FILE_NAME>
